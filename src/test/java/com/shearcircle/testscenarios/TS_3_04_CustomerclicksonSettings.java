...
public class TS_3_04_CustomerclicksonSettings extends StaticVariables {
	...
	@Test(priority=3407, description="TC_3_4_05 Check whether Change Password link is clickable")
	...
	@Test(priority=3408, description="TC_3_4_06 Check whether the password can be updated without entering any data")
	...
	@Test(priority=3409, description="TC_3_4_07 Check whether the password can be updated by entering new password less than 6 characters/spaces")
	...
	@Test(priority=3410, description="TC_3_4_08 Check whether password can be updated by entering valid data")
	...
	@Test(priority=3411, description="TC_3_4_09 Check whether the Cancel button is clickable in Secure password change page")
