...
public void Subscriber_Registration(){
		...
		if(browser.elementisdisplayed(Login.Home_JoinOurCircle_Link)) {
			...
			//browser.wait(5);
					...
					browser.Verify_elementisdisplayed_Report(SCobjects.Subscriber_ReEnterPassword_textbox, "ReEnteredPassword textbox");
					browser.sendkeys(SCobjects.Subscriber_ReEnterPassword_textbox,Password);
					browser.Verify_elementisdisplayed_Report(SCobjects.Subscriber_Termsofservice_checkbox, "Termsofservice checkbox");
					browser.check_Checkbox(SCobjects.Subscriber_Termsofservice_checkbox);
					browser.Verify_elementisdisplayed_Report(SCobjects.Subscriber_billingagrement_checkbox, "billingagrement Checkbox");
