...
public class TS_2_09_CustomerclicksonLoginwithGooglebutton extends StaticVariables {
	public String TestDataPath;
	public Customer_Module_Page_Components CR;
	public CommonFunctions cfn;
	public static WebDriver driver;
	
	public TS_2_09_CustomerclicksonLoginwithGooglebutton() throws IOException, InterruptedException{
